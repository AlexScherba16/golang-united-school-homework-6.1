...
func (b *box) GetByIndex(i int) (Shape, error) {
	if b.isOutOfRange(i) == true {
		return nil, errors.New("GetByIndex: index out of range")
	}
...
func (b *box) ExtractByIndex(i int) (Shape, error) {
	if b.isOutOfRange(i) == true {
		return nil, errors.New("ExtractByIndex: index out of range")
	}
	result := b.shapes[i]
...
func (b *box) ReplaceByIndex(i int, shape Shape) (Shape, error) {
	if b.isOutOfRange(i) == true {
		return nil, errors.New("ReplaceByIndex: index out of range")
	}
	result := b.shapes[i]
	b.shapes[i] = shape
	return result, nil
